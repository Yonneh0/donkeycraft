(function () {
  ...
  Donkeycraft.ElegantStoneDoubleDoor.prototype = Object.create(
    Donkeycraft.Entity.prototype
  );
  Donkeycraft.ElegantStoneDoubleDoor.prototype.constructor =
  ...
  Donkeycraft.ElegantStoneDoubleDoor.prototype.tick = function (deltaTime) {
    ...
    if (this._animationController) {
      if (this.openProgress > 0 && this.openProgress < 1) {
        ...
        this._animationController.setForcedState(
          this.isOpen ? 'doorOpen' : 'doorClose',
          Math.max(remainingTime, 0.05)
        );
