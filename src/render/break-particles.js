...
(function () {
   ...
   */
  Donkeycraft.BreakParticles.prototype._getBlockParticleColor = function (
    blockId
  ) {
    ...
    switch (blockId) {
      ...
      case 5:
        return { r: 0.8, g: 0.75, b: 0.2 }; // gold block
      case 6:
        return { r: 0.4, g: 0.7, b: 0.85 }; // diamond
      case 7:
        return { r: 0.45, g: 0.3, b: 0.18 }; // oak log
      case 8:
        return { r: 0.62, g: 0.45, b: 0.25 }; // oak plank
      case 9:
   ...
   */
  Donkeycraft.BreakParticles.prototype._colorFromBlockInfo = function (
    blockInfo
  ) {
  ...
  Donkeycraft.BreakParticles.prototype.render = function (camera) {
    ...
    // Disable depth writes so particles render on top of terrain (translucent overlay).
    gl.depthMask(false);
    ...
    try {
      ...
      var totalFloats =
        this._particles.length * vertPerParticle * floatsPerVertex;
