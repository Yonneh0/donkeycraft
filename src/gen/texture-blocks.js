...
(function () {
  ...
  function generateBricks(r, g, b) {
    ...
    for (var row = 0; row < TEX_SIZE; row += brickH) {
      ...
      for (var col = -4 + offset; col < TEX_SIZE; col += 8) {
        ...
        ctx.fillStyle =
          'rgb(' +
          Math.max(0, Math.min(255, brickR)) +
          ',' +
          Math.max(0, Math.min(255, brickG)) +
          ',' +
          Math.max(0, Math.min(255, brickB)) +
          ')';
  ...
  Donkeycraft.TextureGenerator.generateNetherQuartzOre =
    generateNetherQuartzOre;
  ...
  Donkeycraft.TextureGenerator.generateCobbledDeepslate =
    generateCobbledDeepslate;
  Donkeycraft.TextureGenerator.generatePolishedDeepslate =
    generatePolishedDeepslate;
})();
