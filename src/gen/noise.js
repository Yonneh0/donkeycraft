...
(function () {
  ...
  function _noise2D(x, y) {
    ...
    if (
      ...
      typeof Donkeycraft.PerlinNoise.noise2D === 'function'
    ) {
      try {
  ...
  function _fbm(x, y, z, octaves, amplitude, frequency) {
    ...
    if (
      Donkeycraft.PerlinNoise &&
      typeof Donkeycraft.PerlinNoise.fbm === 'function'
    ) {
      try {
  ...
  function _shufflePerm(seed) {
    if (
      !Donkeycraft.PerlinNoise ||
      typeof Donkeycraft.PerlinNoise._setPerm !== 'function'
    ) {
  ...
  function _createShuffledPerm(seed) {
    if (
      Donkeycraft.PerlinNoise &&
      typeof Donkeycraft.PerlinNoise._getPerm === 'function'
    ) {
      try {
  ...
  function _ridgedMultifractal(
    ...
    for (var i = 0; i < octaves; i++) {
      ...
      var noiseValue = Math.abs(
        Donkeycraft.PerlinNoise.noise3D(
          x * frequency,
          y * frequency,
          z * frequency
        )
  ...
  function _valleyNoise(x, y, z, octaves, persistence, lacunarity) {
    ...
    var fbmValue = Donkeycraft.PerlinNoise.fbm(
      x,
      y,
      z || 0,
      octaves,
   ...
   * @private
   */
  function _createTerrainComposition(
    continentalScale,
    terrainScale,
    detailScale,
    ridgeScale,
