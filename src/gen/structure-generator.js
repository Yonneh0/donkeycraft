...
(function () {
  ...
  function _resolveDecorationBlocks() {
    ...
    var blockVariants = [
      ...
      {
        key: 'ice_formation',
        variants: ['ice_formation', 'ice', 'packed_ice'],
      },
  ...
  function _buildDecorationConfigurations() {
    ...
    _decorators['grass'] = [
      ...
      new Decorator(
        'flower',
        _resolvedBlocks['flower_yellow'] || 0,
        ['grass'],
        5,
        {}
      ),
    ...
    _decorators['arctic'] = [
      ...
      new Decorator(
        'snow_layer',
        _resolvedBlocks['snow_layer'] || _resolvedBlocks['snow_block'] || 0,
        ['arctic'],
        1,
        {
          layerThickness: 2,
      ...
      new Decorator(
        'ice_formation',
        _resolvedBlocks['ice_formation'] || _resolvedBlocks['ice'] || 0,
        ['arctic'],
        2,
        {}
      ),
    ...
    _decorators['desert'] = [
      new Decorator(
        'cactus',
        _resolvedBlocks['cactus_block'] || 0,
        ['desert'],
        4,
        {
          heightMin: 2,
  ...
  function placeDecorations(chunk, chunkX, chunkZ, biomeName, heightmap) {
    ...
    for (var i = 0; i < decorations.length; i++) {
      ...
      switch (dec.name) {
        ...
        case 'birch_tree':
        case 'dead_tree':
          stats.decorationsPlaced += _placeTree(
            chunk,
            chunkX,
            chunkZ,
            dec,
          ...
          break;
        case 'cactus':
          stats.decorationsPlaced += _placeCactus(
            chunk,
            chunkX,
            chunkZ,
            dec,
          ...
          break;
        case 'mushroom':
          stats.decorationsPlaced += _placeMushroom(
            chunk,
            chunkX,
            chunkZ,
            dec,
          ...
          break;
        default:
          stats.decorationsPlaced += _placeSimpleDecoration(
            chunk,
            chunkX,
            chunkZ,
            dec,
  ...
  function _placeTree(chunk, chunkX, chunkZ, dec, heightmap) {
    ...
    for (var t = 0; t < treeCount; t++) {
      ...
      var trunkHeight =
        dec.options.heightMin +
        ((rngSeed >> (t * 4 + 2)) %
          (dec.options.heightMax - dec.options.heightMin + 1));
