...
(function () {
  ...
  Donkeycraft.ChestUI.prototype._updateSlotDisplay = function (index, stack) {
    ...
    if (typeof index !== 'number' || index < 0 || index >= this._slotEls.length)
      return;
   ...
   * @private
   */
  Donkeycraft.ChestUI.prototype._emitSlotChange = function (
    index,
    newStack,
    oldStack
  ) {
