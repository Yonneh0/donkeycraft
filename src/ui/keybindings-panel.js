...
(function () {
    ...
    Donkeycraft.KeybindingsPanel.prototype._buildKeycapHTML = function (text) {
        ...
        return '<span class="dk-keycap ' + cls + '"><span class="dk-kb-key-text">' + text + '</span></span>';
    };
     ...
     */
    Donkeycraft.KeybindingsPanel.prototype._buildKeyItemHTML = function (keyText, label) {
        return '<span class="dk-kb-key-item">' +
            this._buildKeycapHTML(keyText) +
            '<span class="dk-kb-label">' + label + '</span>' +
            '</span>';
    };
     ...
     * @returns {string} HTML string.
     */
    Donkeycraft.KeybindingsPanel.prototype._buildHTMLString = function (kb, isCreative, isFlying) {
        var self = this;
        ...
        function groupWithSharedLabel(keysHtml, label) {
            return '<span class="dk-kb-group">' + keysHtml + '</span>' +
                '<span class="dk-kb-key-item"><span class="dk-kb-label" style="visibility:hidden;">.</span><span class="dk-kb-label">' + label + '</span></span>';
        }

        var parts = [];

        // Movement group (W A S D)
        parts.push(groupWithSharedLabel(
            keyItem('W', '') + ' ' +
            keyItem('A', '') + ' ' +
            keyItem('S', '') + ' ' +
            keyItem('D', ''),
        ...
        parts.push('<span class="dk-kb-group dk-kb-input-status" id="dk-kb-input-status">' +
    ...
    Donkeycraft.KeybindingsPanel.prototype.update = function (input) {
        ...
        if (!this._htmlBuilt || this._gameModeDirty || this._flyingDirty) {
            ...
            this._element.innerHTML = this._buildHTMLString(kb, this._gameMode === 'creative', this._isFlying);
