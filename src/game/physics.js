...
(function () {
    ...
    Donkeycraft.Physics = (function () {
        ...
        function applyGravity(chunk, x, y, z) {
            if (!chunk || typeof x !== 'number' || typeof y !== 'number' || typeof z !== 'number') return false;
        ...
        function flowLiquid(chunk, x, y, z, sourceLevel) {
            if (!chunk || typeof x !== 'number' || typeof y !== 'number' || typeof z !== 'number') return 0;
            ...
            for (var i = 0; i < directions.length; i++) {
                ...
                // Flow into same liquid type (merge if neighbor is lower)
                    ...
                    if (neighborLevel < sourceLevel) {
                        _setLiquidLevel(chunk, nx, y, nz, Math.max(neighborLevel + 1, sourceLevel - 1));
