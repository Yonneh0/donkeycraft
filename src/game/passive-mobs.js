...
(function () {
  ...
  // Inherit from Entity
  Donkeycraft.PassiveMob.prototype = Object.create(
   ...
   */
  Donkeycraft.PassiveMob.prototype.isPlayerNearby = function (
    player,
    fleeRange
  ) {
    ...
    if (Donkeycraft.EventBus) {
      try {
        var count =
          this.dropCount[0] +
          Math.floor(
            Math.random() * (this.dropCount[1] - this.dropCount[0] + 1)
          );
