...
(function () {
  ...
  Donkeycraft.BlockAction = (function () {
    ...
    function _getBlockIdAt(globalX, globalY, globalZ) {
      ...
      if (
        globalY < 0 ||
        globalY >= (Donkeycraft.Config ? Donkeycraft.Config.WORLD_HEIGHT : 256)
      )
        return 0;
    ...
    function getBlockHardness(blockId) {
      ...
      if (
        ...
        typeof Donkeycraft.BlockRegistry.getBlockById === 'function'
      ) {
    ...
    function tickBreakProgress(deltaTime) {
      ...
      for (var i = 0; i < stateKeys.length; i++) {
        ...
        if (
          ...
          typeof Donkeycraft.WorldUtils.isChunkLoaded === 'function'
        ) {
          chunkLoaded = Donkeycraft.WorldUtils.isChunkLoaded(
            _chunkManager,
            state.x,
            state.z
          );
