...
(function () {
  ...
  Donkeycraft.InteractableBlocks = (function () {
    ...
    function getInteractionType(blockId) {
      switch (blockId) {
        case INTERACTIVE_BLOCK_IDS.CHEST:
          return 'chest';
        case INTERACTIVE_BLOCK_IDS.FURNACE:
          return 'furnace';
        case INTERACTIVE_BLOCK_IDS.DOOR_WOOD:
        case INTERACTIVE_BLOCK_IDS.DOOR_IRON:
          return 'door';
        case INTERACTIVE_BLOCK_IDS.TRAPDOOR:
          return 'trapdoor';
        case INTERACTIVE_BLOCK_IDS.LEVER:
          return 'lever';
        case INTERACTIVE_BLOCK_IDS.BUTTON_STONE:
        case INTERACTIVE_BLOCK_IDS.BUTTON_WOOD:
          return 'button';
    ...
    function toggleDoor(chunkManager, x, y, z, isTrapdoor) {
      ...
      var currentBlockId = Donkeycraft.WorldUtils.getBlockAt(
        chunkManager,
        ix,
        iy,
        iz
    ...
    function toggleLever(chunkManager, x, y, z) {
      ...
      if (newState === 'on' && Donkeycraft.RedstoneEngine) {
        Donkeycraft.RedstoneEngine.updateRedstoneSignal(
          chunkManager,
          ix,
          iy,
          iz,
    ...
    function pressButton(chunkManager, x, y, z) {
      ...
      if (
        _buttonStates[key] &&
        _buttonStates[key].activeUntilTick > _currentTick
      ) {
    ...
    function getInteractiveState(x, y, z) {
      var key = Donkeycraft.WorldUtils.makeStateKey(
        Math.floor(x),
        Math.floor(y),
        Math.floor(z)
      );
