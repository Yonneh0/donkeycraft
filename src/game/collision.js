...
(function () {
   ...
   */
  Donkeycraft.Collision.prototype.checkMovement = function (
    position,
    width,
    height,
    deltaX,
    ...
    var collisionX = this._checkAABBAgainstBlocks(
      aabbBefore.minX + deltaX,
      aabbBefore.minY,
      aabbBefore.minZ,
      aabbBefore.maxX + deltaX,
      aabbBefore.maxY,
      aabbBefore.maxZ
    );
    ...
    var collisionY = this._checkAABBAgainstBlocks(
      aabbBefore.minX,
      aabbBefore.minY + deltaY,
      aabbBefore.minZ,
      aabbBefore.maxX,
      aabbBefore.maxY + deltaY,
      aabbBefore.maxZ
    );
    ...
    var collisionZ = this._checkAABBAgainstBlocks(
      aabbBefore.minX,
      aabbBefore.minY,
      aabbBefore.minZ + deltaZ,
      aabbBefore.maxX,
      aabbBefore.maxY,
      aabbBefore.maxZ + deltaZ
    );
   ...
   */
  Donkeycraft.Collision.prototype.resolveMovementWithDelta = function (
    position,
    velocity,
    width,
    height,
    ...
    if (
      ...
      return {
        newX: position ? position.x : 0,
        newY: position ? position.y : 0,
        newZ: position ? position.z : 0,
        onGround: false,
      };
    }
    ...
    return this._resolveDisplacement(
      position,
      deltaX,
      deltaY,
      deltaZ,
   ...
   * @private
   */
  Donkeycraft.Collision.prototype._resolveDisplacement = function (
    position,
    deltaX,
    deltaY,
    deltaZ,
    ...
    if (this._pushOutOfBlocks(aabb)) {
      ...
      if (!pushedOut) {
        ...
        while (
          this._aabbOverlapsSolidsAndLiquids(
            aabb.minX,
            checkY,
            aabb.minZ,
            aabb.maxX,
    ...
    if (deltaY !== 0) {
      ...
      if (
        ...
        if (deltaY < 0 && onGround) {
          ...
          var corners = [
            {
              x: Math.floor(aabb.minX + 0.01),
              z: Math.floor(aabb.minZ + 0.01),
            },
            {
              x: Math.floor(aabb.maxX - 0.01),
              z: Math.floor(aabb.minZ + 0.01),
            },
            {
              x: Math.floor(aabb.minX + 0.01),
              z: Math.floor(aabb.maxZ - 0.01),
            },
            {
              x: Math.floor(aabb.maxX - 0.01),
              z: Math.floor(aabb.maxZ - 0.01),
   ...
   * @private
   */
  Donkeycraft.Collision.prototype._aabbOverlapsSolid = function (
    minX,
    minY,
    minZ,
    maxX,
   ...
   * @private
   */
  Donkeycraft.Collision.prototype._aabbOverlapsSolidsAndLiquids = function (
    minX,
    minY,
    minZ,
    maxX,
   ...
   */
  Donkeycraft.Collision.prototype.isBlockSolid = function (
    globalX,
    globalY,
    globalZ
  ) {
   ...
   */
  Donkeycraft.Collision.prototype.isBlockReplaceable = function (
    globalX,
    globalY,
    globalZ
  ) {
   ...
   */
  Donkeycraft.Collision.prototype.isBlockLiquid = function (
    globalX,
    globalY,
    globalZ
  ) {
   ...
   */
  Donkeycraft.Collision.prototype.isBlockLava = function (
    globalX,
    globalY,
    globalZ
  ) {
   ...
   */
  Donkeycraft.Collision.prototype.getOverlappingBlocks = function (
    minX,
    minY,
    minZ,
    maxX,
        ...
        for (var z = startZ; z < endZ; z++) {
          if (this.isBlockSolid(x, y, z)) {
            blocks.push({
              ...
              y: y,
              z: z,
              blockId: this._getBlockIdAt(x, y, z),
            });
          }
        }
      }
   ...
   * @private
   */
  Donkeycraft.Collision.prototype._checkAABBAgainstBlocks = function (
    minX,
    minY,
    minZ,
    maxX,
   ...
   * @private
   */
  Donkeycraft.Collision.prototype._getBlockIdAt = function (
    globalX,
    globalY,
    globalZ
  ) {
   ...
   */
  Donkeycraft.Collision.prototype.checkEntityCollision = function (
    position,
    width,
    height,
    entities
    ...
    for (var i = 0; i < entities.length; i++) {
      ...
      var eDims = entity.getDimensions
