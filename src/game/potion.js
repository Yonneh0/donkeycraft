...
(function () {
   ...
   */
  Donkeycraft.PotionEffect = function (
    id,
    name,
    r,
    g,
  ...
  Donkeycraft.PotionRegistry = (function () {
    ...
    function registerEffects() {
      ...
      registerEffect(
        new Donkeycraft.PotionEffect(2, 'Speed', 47, 137, 255, 600, 1800, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(3, 'Slowness', 50, 50, 150, 300, 900, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(4, 'Haste', 200, 200, 50, 600, 1800, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(
          5,
      ...
      registerEffect(
        new Donkeycraft.PotionEffect(6, 'Strength', 200, 50, 50, 600, 1800, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(7, 'InstantHealth', 255, 0, 0, 1, 1, 0)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(8, 'InstantDamage', 80, 0, 80, 1, 1, 0)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(
          9,
      ...
      registerEffect(
        new Donkeycraft.PotionEffect(10, 'Nausea', 100, 0, 100, 300, 600, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(
          11,
      ...
      registerEffect(
        new Donkeycraft.PotionEffect(12, 'Luck', 255, 215, 0, 600, 1800, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(13, 'Unluck', 50, 20, 0, 600, 1800, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(
          14,
      ...
      registerEffect(
        new Donkeycraft.PotionEffect(17, 'BadOmen', 100, 50, 0, 1200, 3600, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(
          18,
      ...
      registerEffect(
        new Donkeycraft.PotionEffect(19, 'Weakness', 50, 50, 50, 300, 900, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(20, 'Stamina', 248, 192, 60, 600, 1800, 4)
      );
      registerEffect(
        new Donkeycraft.PotionEffect(21, 'Hydration', 248, 160, 60, 300, 600, 0)
      );
    ...
    function registerPotions() {
      ...
      registerPotion(
        new Donkeycraft.Potion(1, 'Water Bottle', 0, 0, [], false, null)
      );

      // Awkward Potion: Nether Wart (241) + Water Bottle (1)
      registerPotion(
        new Donkeycraft.Potion(2, 'Awkward Potion', 241, 1, [], false, null)
      );

      // Mundane Potion: Spider eye (239) + Water Bottle (1) — base ineffective potion
      registerPotion(
        new Donkeycraft.Potion(3, 'Mundane Potion', 239, 1, [], false, '7F5C18')
      );

      // Thick Potion: Fermented Spider Eye (240) + Water Bottle (1) — base ineffective potion
      registerPotion(
        new Donkeycraft.Potion(4, 'Thick Potion', 240, 1, [], false, 'C76A1E')
      );

      // Regeneration: Ghast Tear (237) + Awkward (2)
      registerPotion(
        new Donkeycraft.Potion(
          10,
          'Potion of Regeneration',
          237,
          2,
          [{ effectId: 1, amplifier: 0, duration: 900 }],
          false,
          'C73850'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          10,
          [{ effectId: 1, amplifier: 1, duration: 450 }],
          false,
          'A82E3E'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          242,
          2,
          [{ effectId: 2, amplifier: 0, duration: 900 }],
          false,
          '2F89FF'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          12,
          [{ effectId: 2, amplifier: 1, duration: 450 }],
          false,
          '1A6FE0'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          239,
          2,
          [{ effectId: 3, amplifier: 0, duration: 450 }],
          false,
          '323296'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          14,
          [{ effectId: 3, amplifier: 1, duration: 225 }],
          false,
          '1E1E6B'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          242,
          2,
          [{ effectId: 4, amplifier: 0, duration: 900 }],
          false,
          'C8C832'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          16,
          [{ effectId: 4, amplifier: 1, duration: 450 }],
          false,
          '9E9E28'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          239,
          2,
          [{ effectId: 5, amplifier: 0, duration: 450 }],
          false,
          '64503C'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          243,
          2,
          [{ effectId: 6, amplifier: 0, duration: 900 }],
          false,
          'C83232'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          19,
          [{ effectId: 6, amplifier: 1, duration: 450 }],
          false,
          'A02828'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          237,
          2,
          [{ effectId: 7, amplifier: 0, duration: 1 }],
          true,
          'F8421A'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          21,
          [{ effectId: 7, amplifier: 1, duration: 1 }],
          true,
          'FF6B4D'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          239,
          2,
          [{ effectId: 8, amplifier: 0, duration: 1 }],
          true,
          '4A0848'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          24,
          'Potion of Instant Damage II',
          236,
          23,
          [{ effectId: 8, amplifier: 1, duration: 1 }],
          true,
          '6B0C69'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          242,
          2,
          [{ effectId: 9, amplifier: 0, duration: 900 }],
          false,
          '64FF64'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          240,
          2,
          [{ effectId: 10, amplifier: 0, duration: 300 }],
          false,
          '660066'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          243,
          2,
          [{ effectId: 12, amplifier: 0, duration: 900 }],
          false,
          'E86B2F'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          27,
          [{ effectId: 12, amplifier: 0, duration: 450 }],
          false,
          'C45A28'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          245,
          2,
          [{ effectId: 15, amplifier: 0, duration: 900 }],
          false,
          'C8B842'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          29,
          [{ effectId: 15, amplifier: 0, duration: 450 }],
          false,
          'A09030'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          240,
          2,
          [{ effectId: 19, amplifier: 0, duration: 240 }],
          false,
          '5C5C5C'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          239,
          2,
          [{ effectId: 1, amplifier: 0, duration: 450 }],
          false,
          '388838'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          32,
          [{ effectId: 1, amplifier: 1, duration: 225 }],
          false,
          '2A682A'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          246,
          2,
          [{ effectId: 11, amplifier: 0, duration: 600 }],
          false,
          '3858A8'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          236,
          34,
          [{ effectId: 11, amplifier: 0, duration: 300 }],
          false,
          '284078'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          247,
          2,
          [{ effectId: 20, amplifier: 0, duration: 900 }],
          false,
          'F8C848'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          39,
          'Potion of Stamina II',
          236,
          38,
          [{ effectId: 20, amplifier: 1, duration: 450 }],
          false,
          'D0A030'
        )
      );
      ...
      registerPotion(
        new Donkeycraft.Potion(
          ...
          245,
          2,
          [{ effectId: 21, amplifier: 0, duration: 300 }],
          false,
          'F8A848'
        )
      );
    ...
    function matchBrewingRecipe(ingredientId, basePotionId) {
      for (var i = 0; i < _brewingRecipes.length; i++) {
        ...
        if (
          ...
          recipe.basePotionId === basePotionId
        ) {
   ...
   */
  Donkeycraft.ActivePotion = function (
    effectId,
    amplifier,
    duration,
    maxDuration
  ...
  Donkeycraft.ActivePotionManager = (function () {
    ...
    function addPotion(entity, potionId, duration, amplifier) {
      ...
      for (var i = 0; i < effects.length; i++) {
        ...
        var usedDuration =
          duration !== undefined ? duration : eff.duration || 600;
        var usedAmplifier =
          amplifier !== undefined ? amplifier : eff.amplifier || 0;
        ...
        if (existing) {
          ...
          existing.amplifier = Math.max(
            existing.amplifier,
            activePotion.amplifier
          );
          existing.remainingTicks = Math.max(
            existing.remainingTicks,
            activePotion.remainingTicks
          );
          added.push(existing);
        } else {
