...
(function () {
    ...
    Donkeycraft.RecipeRegistry = (function () {
         ...
         * @returns {Donkeycraft.Recipe}
         */
        function registerShaped(id, ingredients, gridSize, outputBlockId, outputCount) {
            var recipe = new Donkeycraft.Recipe(id, 'shaped', ingredients, gridSize, outputBlockId, outputCount);
            _shapedRecipes.push(recipe);
            return recipe;
        }
        ...
        function registerShapeless(id, ingredients, outputBlockId, outputCount) {
            var recipe = new Donkeycraft.Recipe(id, 'shapeless', ingredients, 0, outputBlockId, outputCount);
            _shapelessRecipes.push(recipe);
            return recipe;
        }
        ...
        function registerSmelt(id, inputBlockId, outputBlockId, cookingTime) {
            var recipe = new Donkeycraft.Recipe(id, 'smelt', [{ id: inputBlockId }], 0, outputBlockId, 1, cookingTime);
        ...
        // Furnace
        registerShaped(22, [138, 138, 138, 138, null, null, 138, 138, 138], 3, 191, 1);  // cobblestone -> furnace
        ...
        // Bowl
        registerShaped(29, [30, null, null, 30, null, null, 30, null, null], 3, 319, 1);  // planks -> bowl (simplified)
        ...
        // Enchanting table
        registerShaped(31, [227, 219, 227, 214, 214, 214, 210, 210, 210], 3, 199, 1);  // diamonds + obsidian + blood moon -> enchanting_table

        // Anvil
        registerShaped(32, [226, null, 226, null, null, null, 221, 221, 221], 3, 196, 1);  // iron_block + iron_ingot -> anvil

        // Beacon
        registerShaped(33, [227, 227, 227, 227, 211, 227, 227, 227, 227], 3, 321, 1);  // 5 diamonds + glass + nether_star -> beacon

        // Clock
        registerShaped(34, [222, 222, 222, 222, 214, 222, 222, 222, 222], 3, 322, 1);  // gold_ingot + redstone -> clock

        // Compass
        registerShaped(35, [222, 222, 222, 214, 222, 222, 222, 222, 222], 3, 323, 1);  // gold_ingot + redstone -> compass

        // Redstone lamp
        registerShaped(36, [230, 230, 230, 230, 225, 230, 230, 230, 230], 3, 175, 1);  // redstone + gold -> redstone_lamp

        // Dropper
        registerShaped(37, [138, 138, 138, 138, 230, 138, 138, 230, 138], 3, 178, 1);  // cobblestone + redstone -> dropper

        // Dispenser
        registerShaped(38, [138, 138, 138, 138, 230, 138, 138, 310, 138], 3, 177, 1);  // cobblestone + redstone + bow -> dispenser

        // Note block
        registerShaped(39, [30, 30, 30, 30, 219, 30, 30, 30, 30], 3, 324, 1);  // planks + emerald -> note_block

        // Piston
        registerShaped(40, [138, 138, 138, 138, 230, 138, 138, 126, 138], 3, 181, 1);  // cobblestone + redstone + obsidian -> piston

        // Sticky piston
        registerShaped(41, [181, null, 213, null, null, null], 3, 182, 1);  // piston + slime_ball -> sticky_piston

        // Observer
        registerShaped(42, [138, 138, null, 230, 230, null, 227, 227, null], 3, 179, 1);  // cobblestone + redstone + quartz -> observer
        ...
        registerShaped(48, [227, 227, null, 47, 47, null, 234, 234, null], 3, 326, 1);

        // Glazed terracotta (simplified)
        registerShaped(49, [101, 101, 101, 101, 230, 230, 101, 101, 101], 3, 327, 1);

        // Cartography table (not fully implemented)
        registerShaped(50, [30, 30, null, 30, 30, null, null, 310, null], 3, 328, 1);

        // Grindstone (not fully implemented)
        registerShaped(51, [30, 30, null, 310, null, null, 138, null, null], 3, 329, 1);

        // Lectern
        registerShaped(52, [197, null, null, 30, 30, 30, null, null, null], 3, 186, 1);

        // Loom (not fully implemented)
        registerShaped(53, [310, 310, null, 310, 310, null, null, 30, null], 3, 330, 1);

        // Smithing table
        registerShaped(54, [226, null, null, 30, 30, null, null, null, null], 3, 331, 1);

        // Stonecutter
        registerShaped(55, [226, null, null, 214, null, null, null, null, null], 3, 332, 1);

        // Barrel
        registerShaped(56, [36, 36, 36, null, null, null, 36, 36, 36], 3, 190, 1);

        // Campfire (not fully implemented)
        registerShaped(57, [310, 310, 310, 310, 214, 310, null, null, null], 3, 333, 1);
