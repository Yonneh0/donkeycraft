...
(function () {
    ...
    Donkeycraft.BlockRegistry = (function () {
        ...
        // Grass block face variants — separate block IDs for proper atlas UV mapping (must be < 256)
        // ID 233 and ID 140 are both reserved (no block assigned) — available
        ...
        // Each slab drops its own type when broken.
        ...
        registerBlock(130, 'oak_slab', 2.0, 2.0, 129, 1, false, false, 0, 15);
        ...
        // ID 140 reserved — no block assigned
