...
(function () {
    ...
    Donkeycraft.TextureAtlas.prototype.registerBlockTexture = function (blockId, image) {
        ...
        if (!Number.isInteger(blockId) || blockId < 0) {
            Donkeycraft.Logger.warn('TextureAtlas',
                'Invalid blockId for registerBlockTexture: ' + blockId + ' (must be non-negative integer)');
            return false;
        }
    ...
    Donkeycraft.TextureAtlas.prototype.generate = function () {
        ...
        if (!this._texture) {
            Donkeycraft.Logger.error('TextureAtlas', 'Failed to create WebGL texture object');
            return false;
        }
