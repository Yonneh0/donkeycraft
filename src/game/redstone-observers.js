...
(function () {
  ...
  Donkeycraft.RedstoneObservers = (function () {
    ...
    function _processObserver(entry, chunk) {
      ...
      var observePos = _getObservePosition(
        entry.x,
        entry.y,
        entry.z,
        state.facing
      ...
      var currentBlockId = obsChunk.getBlock(
        obsLocalX,
        observePos.y,
        obsLocalZ
      );
    ...
    function _emitPulse(x, y, z, facing) {
      ...
      switch (facing) {
        case FACING_SOUTH:
          backPos = { x: x, y: y, z: z - 1 };
          break;
        case FACING_NORTH:
          backPos = { x: x, y: y, z: z + 1 };
          break;
        case FACING_WEST:
          backPos = { x: x - 1, y: y, z: z };
          break;
        case FACING_EAST:
          backPos = { x: x + 1, y: y, z: z };
          break;
      ...
      if (
        Donkeycraft._redstonePistons &&
        Donkeycraft._redstonePistons.onObserverPulse
      ) {
        Donkeycraft._redstonePistons.onObserverPulse(
          backPos.x,
          backPos.y,
