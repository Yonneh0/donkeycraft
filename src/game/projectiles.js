...
(function () {
  ...
  // Inherit from Entity
  Donkeycraft.Projectile.prototype = Object.create(
  ...
  Donkeycraft.Projectile.prototype.hitsEntity = function (entity) {
    ...
    return (
      projBox.maxX >= entBox.minX &&
      projBox.minX <= entBox.maxX &&
      projBox.maxY >= entBox.minY &&
      projBox.minY <= entBox.maxY &&
      projBox.maxZ >= entBox.minZ &&
      projBox.minZ <= entBox.maxZ
    );
  };
   ...
   */
  Donkeycraft.Projectile.calculateVelocity = function (
    direction,
    speed,
    upwardAngle
  ) {
