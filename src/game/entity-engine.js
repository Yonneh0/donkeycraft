...
(function () {
  ...
  Donkeycraft.AnimationClip.prototype.evaluate = function (time) {
    ...
    for (var boneName in bones) {
      ...
      var t =
        nextKf.time - prevKf.time > 0
          ? (wrappedTime - prevKf.time) / (nextKf.time - prevKf.time)
          : 0;
   ...
   * @param {Donkeycraft.AnimationClip} clip - Animation clip for this state.
   */
  Donkeycraft.AnimationStateMachine.prototype.registerState = function (
    name,
    clip
  ) {
    if (!name || !clip) return;
   ...
   */
  Donkeycraft.AnimationStateMachine.prototype.setState = function (
    name,
    transitionDuration
  ) {
    ...
    if (this._activeState !== name) {
      ...
      this._states[name].transitionDuration =
  ...
  Donkeycraft.AnimationStateMachine.prototype.tick = function (deltaTime) {
    ...
    var currentTransforms = active.clip
      ? active.clip.evaluate(active.time)
      : {};
    ...
    if (prev && prev.clip && this._transitionTime < prev.transitionDuration) {
      ...
      var prevTransforms = prev.clip.evaluate(
        prev.clip.loop
          ? ((prev.time % prev.clip.duration) + prev.clip.duration) %
              prev.clip.duration
      ...
      for (var j = 0; j < this._allBones.length; j++) {
        ...
        this._boneTransforms[boneName] = currentTransforms[boneName] || {
          rx: 0,
          ry: 0,
          rz: 0,
        };
  ...
  Donkeycraft.SkeletonTemplates = {
    ...
    bipedal: [
      new Donkeycraft.BoneDefinition('root', {
        offset: new Donkeycraft.Vector3(0, 0, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('body', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.9, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('head', {
        parent: 'body',
        offset: new Donkeycraft.Vector3(0, 0.9, 0),
        pivot: new Donkeycraft.Vector3(0, 0.15, 0),
      }),
      new Donkeycraft.BoneDefinition('leftArm', {
        parent: 'body',
        offset: new Donkeycraft.Vector3(-0.4, 0.7, 0),
        pivot: new Donkeycraft.Vector3(-0.2, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('rightArm', {
        parent: 'body',
        offset: new Donkeycraft.Vector3(0.4, 0.7, 0),
        pivot: new Donkeycraft.Vector3(0.2, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('leftLeg', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(-0.2, 0, 0),
        pivot: new Donkeycraft.Vector3(-0.1, 0.45, 0),
      }),
      new Donkeycraft.BoneDefinition('rightLeg', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0.2, 0, 0),
        pivot: new Donkeycraft.Vector3(0.1, 0.45, 0),
      }),
    ...
    quadruped: [
      ...
      new Donkeycraft.BoneDefinition('body', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.7, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('head', {
        parent: 'body',
        offset: new Donkeycraft.Vector3(0.6, 0.4, 0),
        pivot: new Donkeycraft.Vector3(0.3, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('frontLeftLeg', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0.4, 0, 0.3),
        pivot: new Donkeycraft.Vector3(0.2, 0.45, 0.15),
      }),
      new Donkeycraft.BoneDefinition('frontRightLeg', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0.4, 0, -0.3),
        pivot: new Donkeycraft.Vector3(0.2, 0.45, -0.15),
      }),
      new Donkeycraft.BoneDefinition('rearLeftLeg', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(-0.4, 0, 0.3),
        pivot: new Donkeycraft.Vector3(-0.2, 0.45, 0.15),
      }),
      new Donkeycraft.BoneDefinition('rearRightLeg', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(-0.4, 0, -0.3),
        pivot: new Donkeycraft.Vector3(-0.2, 0.45, -0.15),
      }),
    ...
    small: [
      ...
      new Donkeycraft.BoneDefinition('body', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.3, 0),
        pivot: new Donkeycraft.Vector3(0, 0.15, 0),
      }),
      new Donkeycraft.BoneDefinition('head', {
        parent: 'body',
        offset: new Donkeycraft.Vector3(0.2, 0.2, 0),
        pivot: new Donkeycraft.Vector3(0.1, 0, 0),
      }),
    ],
    ...
    static: [
      ...
      new Donkeycraft.BoneDefinition('post', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.5, 0),
        pivot: new Donkeycraft.Vector3(0, 0.5, 0),
      }),
      new Donkeycraft.BoneDefinition('sign', {
        parent: 'post',
        offset: new Donkeycraft.Vector3(0, 0.6, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('chest', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.4375, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('furnace', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.5, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
    ...
    door: [
      ...
      new Donkeycraft.BoneDefinition('doorPanel', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.9, 0),
        pivot: new Donkeycraft.Vector3(-0.45, 0, 0),
      }),
    ],
    ...
    projectile: [
      ...
      new Donkeycraft.BoneDefinition('shaft', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('tip', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0.4, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
      new Donkeycraft.BoneDefinition('sphere', {
        parent: 'root',
        offset: new Donkeycraft.Vector3(0, 0, 0),
        pivot: new Donkeycraft.Vector3(0, 0, 0),
      }),
   ...
   */
  Donkeycraft.KinematicState.prototype.tick = function (
    deltaTime,
    groundCheck
  ) {
    if (deltaTime <= 0)
    ...
    if (groundCheck && typeof groundCheck === 'function') {
      ...
      if (groundY !== null && groundY !== undefined) {
        ...
        var frictionDamp = Math.pow(
          this.groundFriction,
          deltaTime * GROUND_FRICTION_BASE_RATE
        );
   ...
   */
  Donkeycraft.KinematicState.prototype.setHorizontalSpeed = function (
    speed,
    yaw
  ) {
    if (speed < 0) speed = 0;
   ...
   * @param {number} [transitionDuration=0.2] - Transition time in seconds.
   */
  Donkeycraft.EntityAnimationController.prototype.setState = function (
    name,
    transitionDuration
  ) {
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.registerAnimations =
    function (clips) {
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.setForcedState = function (
    state,
    duration
  ) {
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.clearForcedState =
    function () {
      this.forcedState = null;
      this.forcedStateDuration = 0;
      this._forcedStateTimer = 0;
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.tick = function (
    deltaTime,
    groundCheck
  ) {
    ...
    this._cachedTransforms = this._stateMachine.tick(
      deltaTime * this.animationSpeedMultiplier
    );
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.getBoneTransforms =
    function () {
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.setSpeed = function (
    speed,
    yaw
  ) {
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.applyVelocity = function (
    vx,
    vy,
    vz
  ) {
   ...
   */
  Donkeycraft.EntityAnimationController.prototype.playAnimation = function (
    name
  ) {
    ...
    if (!cachedClip) {
      cachedClip = new Donkeycraft.AnimationClip(
        name,
        def.duration,
        def.loop,
        def.keyframes
   ...
   */
  Donkeycraft.EntityEngine.prototype.setBlockIdFunction = function (
    getBlockId
  ) {
   ...
   */
  Donkeycraft.EntityEngine.prototype.registerEntityConstructor = function (
    type,
    constructor
  ) {
   ...
   */
  Donkeycraft.EntityEngine.prototype.initializeEntityConstructors =
    function () {
      ...
      var typeMap = [
        ...
        'pig',
        'sheep',
        'chicken', // Passive mobs
        'zombie',
        'skeleton',
        'spider',
        'creeper',
        'enderman', // Hostile mobs
      ...
      for (var i = 0; i < typeMap.length; i++) {
        ...
        if (
          Donkeycraft[ctorName] &&
          typeof Donkeycraft[ctorName] === 'function'
        ) {
      ...
      if (Donkeycraft.ElegantStoneDoubleDoor) {
        this._entityConstructors['elegant_stone_double_door'] =
          Donkeycraft.ElegantStoneDoubleDoor;
