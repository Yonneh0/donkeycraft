...
(function () {
    ...
    Donkeycraft.ToolRegistry = (function () {
        ...
        function registerMaterials() {
            // No tool (bare hands)
            registerMaterial(new Donkeycraft.ToolMaterial(0, 'None', 0, 1.0, 0, 0, 0));

            // Wood: 60 uses, 2x speed, level 0, enchantability 15, repair with oak plank
            registerMaterial(new Donkeycraft.ToolMaterial(1, 'Wood', 60, 2.0, 0, 15, 5));

            // Stone: 132 uses, 4x speed, level 1, enchantability 5, repair with cobblestone
            registerMaterial(new Donkeycraft.ToolMaterial(2, 'Stone', 132, 4.0, 1, 5, 1));

            // Iron: 251 uses, 6x speed, level 2, enchantability 14, repair with iron ingot
            registerMaterial(new Donkeycraft.ToolMaterial(3, 'Iron', 251, 6.0, 2, 14, 221));

            // Diamond: 1562 uses, 8x speed, level 3, enchantability 10, repair with diamond
            registerMaterial(new Donkeycraft.ToolMaterial(4, 'Diamond', 1562, 8.0, 3, 10, 227));

            // Gold: 196 uses, 12x speed, level 0, enchantability 22, repair with gold ingot
            registerMaterial(new Donkeycraft.ToolMaterial(5, 'Gold', 196, 12.0, 0, 22, 226));

            // Netherite: 2032 uses, 9x speed, level 4, enchantability 15, repair with netherite ingot
            registerMaterial(new Donkeycraft.ToolMaterial(6, 'Netherite', 2032, 9.0, 4, 15, 187));
    ...
    Donkeycraft.Tool.prototype.repairWithItem = function (repairItemBlockId) {
        ...
        this._currentDurability = Math.min(this._maxDurability, this._currentDurability + repairAmount);
