...
(function () {
  ...
  Donkeycraft.BlockModelRegistry = (function () {
    ...
    function _shouldUseAO(block) {
      ...
      var isFullSolid =
        !block.transparent && block.lightOpacity >= 15 && block.hardness >= 0;
    ...
    function getFaceUV(blockId, faceName) {
      ...
      if (model) {
        ...
        var fallbackBlock = Donkeycraft.BlockRegistry
      ...
      var textureBlock = Donkeycraft.BlockRegistry
        ? Donkeycraft.BlockRegistry.getBlockByName(textureName)
        : null;
