...
(function () {
    ...
    function _getColorFromName(name) {
        ...
        if (n === 'stone' || n === 'cobbled_deepslate') return [0.50, 0.50, 0.50];
        if (n === 'granite') return [0.76, 0.58, 0.54];
        if (n === 'diorite') return [0.82, 0.82, 0.80];
        if (n === 'andesite') return [0.47, 0.50, 0.50];
        if (n === 'deepslate') return [0.30, 0.28, 0.32];
        if (n === 'dirt') return [0.50, 0.35, 0.20];
        if (n === 'gravel') return [0.55, 0.53, 0.47];
        if (n === 'sand') return [0.92, 0.86, 0.55];
        if (n === 'red_sand') return [0.72, 0.41, 0.25];
        if (n.indexOf('log') >= 0 || n.indexOf('_wood') >= 0 || n.indexOf('hyphae') >= 0) return [0.43, 0.31, 0.18];
        if (n.indexOf('planks') >= 0 || n.indexOf('_fence') >= 0) return [0.65, 0.49, 0.27];
        if (n === 'coal_ore') return [0.25, 0.25, 0.28];
        if (n === 'iron_ore') return [0.70, 0.60, 0.52];
        if (n === 'gold_ore') return [0.90, 0.80, 0.30];
        if (n === 'diamond_ore') return [0.30, 0.85, 0.80];
        if (n === 'emerald_ore') return [0.15, 0.80, 0.30];
        if (n === 'redstone_ore' || n === 'lit_redstone_ore') return [0.60, 0.15, 0.10];
        if (n === 'lapis_ore') return [0.20, 0.35, 0.75];
        if (n === 'nether_quartz_ore') return [0.85, 0.80, 0.65];
        if (n === 'nether_gold_ore') return [0.70, 0.60, 0.35];
        if (n === 'obsidian') return [0.12, 0.10, 0.15];
        if (n === 'crying_obsidian') return [0.40, 0.20, 0.55];
        if (n === 'bedrock') return [0.20, 0.20, 0.20];
        if (n === 'water') return [0.20, 0.40, 0.75];
        if (n === 'lava') return [0.80, 0.30, 0.05];
        if (n === 'snow_block') return [0.95, 0.95, 0.98];
        if (n === 'ice') return [0.60, 0.80, 0.85];
        if (n === 'blue_ice') return [0.30, 0.60, 0.80];
        if (n === 'brick' || n === 'bricks') return [0.60, 0.30, 0.22];
        if (n === 'nether_brick') return [0.20, 0.18, 0.22];
        if (n === 'red_nether_brick') return [0.50, 0.15, 0.12];
        if (n.indexOf('wool') >= 0) return _getWoolColor(n);
        if (n.indexOf('concrete') >= 0) return _getConcreteColor(n);
        if (n === 'sandstone') return [0.92, 0.85, 0.60];
        if (n === 'chiseled_sandstone' || n === 'cut_sandstone') return [0.88, 0.80, 0.55];
        if (n === 'snow_layer') return [0.95, 0.95, 0.98];
        if (n.indexOf('leaves') >= 0) return [0.20, 0.55, 0.15];
        if (n === 'sponge') return [0.90, 0.85, 0.20];
        if (n === 'wet_sponge') return [0.60, 0.55, 0.15];
        if (n === 'honey_block') return [0.85, 0.65, 0.15];
        if (n === 'slime') return [0.25, 0.80, 0.25];
        if (n === 'gold_block') return [0.95, 0.85, 0.20];
        if (n === 'iron_block') return [0.85, 0.82, 0.78];
        if (n === 'diamond_block') return [0.30, 0.90, 0.85];
        if (n === 'emerald_block') return [0.15, 0.85, 0.35];
        if (n === 'lapis_block') return [0.20, 0.30, 0.70];
        if (n === 'redstone_block') return [0.60, 0.10, 0.10];
        if (n === 'coal_block') return [0.15, 0.15, 0.15];
        if (n === 'netherrack') return [0.45, 0.25, 0.22];
        if (n === 'soul_sand') return [0.30, 0.28, 0.25];
        if (n === 'soul_soil') return [0.25, 0.22, 0.20];
        if (n === 'basalt' || n === 'polished_basalt') return [0.35, 0.35, 0.38];
        if (n === 'blackstone' || n === 'gilded_blackstone' || n === 'polished_blackstone') return [0.20, 0.19, 0.22];
        if (n === 'end_stone' || n === 'end_stone_bricks') return [0.82, 0.78, 0.55];
        if (n === 'purpur_block' || n === 'purpur_pillar') return [0.75, 0.50, 0.70];
        if (n === 'chorus_plant') return [0.65, 0.35, 0.55];
        if (n === 'chorus_flower') return [0.80, 0.25, 0.55];
        if (n === 'shroomlight') return [0.90, 0.45, 0.10];
        if (n === 'magma') return [0.75, 0.30, 0.10];
        if (n === 'ancient_debris') return [0.55, 0.40, 0.28];
        if (n.indexOf('warped_') >= 0) return [0.15, 0.55, 0.45];
        if (n.indexOf('crimson_') >= 0) return [0.65, 0.15, 0.15];
        if (n === 'tnt') return [0.70, 0.25, 0.20];
        if (n === 'crafting_table') return [0.55, 0.38, 0.20];
        if (n === 'furnace' || n === 'blast_furnace' || n === 'smoker') return [0.50, 0.50, 0.50];
        if (n === 'lit_furnace') return [0.65, 0.55, 0.40];
        if (n === 'chest' || n === 'trapped_chest' || n === 'barrel') return [0.48, 0.32, 0.15];
        if (n === 'bookshelf') return [0.55, 0.38, 0.22];
        if (n === 'cobblestone') return [0.42, 0.42, 0.42];
        if (n.indexOf('stone_brick') >= 0) {
            if (n === 'mossy_stone_bricks') return [0.40, 0.50, 0.30];
            return [0.42, 0.42, 0.42];
        }
        if (n.indexOf('quartz_block') >= 0 || n === 'chiseled_quartz_block' || n === 'quartz_pillar') return [0.90, 0.87, 0.78];
        if (n === 'smooth_stone') return [0.75, 0.72, 0.68];
        if (n.indexOf('grass') >= 0 && n !== 'grass_block') return [0.25, 0.60, 0.18];
        if (n.indexOf('flower') >= 0 || n === 'poppy' || n === 'blue_orchid' || n === 'dandelion') return [0.30, 0.65, 0.20];
        if (n === 'rose_bush' || n === 'sunflower') return [0.25, 0.55, 0.15];
        if (n === 'fern' || n === 'tall_grass' || n === 'vine') return [0.22, 0.55, 0.16];
        if (n === 'dead_bush') return [0.45, 0.35, 0.20];
        if (n === 'lily_pad') return [0.20, 0.50, 0.15];
        if (n.indexOf('door') >= 0) return [0.55, 0.40, 0.25];
    ...
    function _getWoolColor(name) {
        var p = {
            white: [0.93, 0.93, 0.93], orange: [0.92, 0.51, 0.14], magenta: [0.72, 0.28, 0.73],
            light_blue: [0.39, 0.78, 0.91], yellow: [0.94, 0.87, 0.25], lime: [0.49, 0.89, 0.22],
            pink: [0.92, 0.63, 0.74], gray: [0.32, 0.32, 0.34], light_gray: [0.74, 0.75, 0.76],
            cyan: [0.18, 0.56, 0.60], purple: [0.62, 0.24, 0.68], blue: [0.20, 0.28, 0.73],
            brown: [0.36, 0.25, 0.16], green: [0.32, 0.56, 0.20], red: [0.73, 0.18, 0.14], black: [0.12, 0.12, 0.13]
        };
