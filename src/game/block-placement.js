...
(function () {
    ...
    Donkeycraft.BlockPlacement = (function () {
        ...
        function placeBlock(chunkManager, x, y, z, blockId, player) {
            ...
            } else if (Donkeycraft.WorldUtils && typeof Donkeycraft.WorldUtils.getBlockAt === 'function') {
                currentBlock = Donkeycraft.WorldUtils.getBlockAt(chunkManager, ix, iy, iz);
            }
            ...
            var result = null;
            if (Donkeycraft.WorldUtils && typeof Donkeycraft.WorldUtils.getChunkAndLocalCoords === 'function') {
                result = Donkeycraft.WorldUtils.getChunkAndLocalCoords(chunkManager, ix, iy, iz);
            }
        ...
        function placeBlockFromRaycast(chunkManager, hitX, hitY, hitZ, faceNormalX, faceNormalY, faceNormalZ, blockId, player) {
            ...
            if (typeof hitX !== 'number' || typeof hitY !== 'number' || typeof hitZ !== 'number') return false;
            if (typeof faceNormalX !== 'number' || typeof faceNormalY !== 'number' || typeof faceNormalZ !== 'number') return false;
