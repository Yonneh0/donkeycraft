...
(function () {
  ...
  Donkeycraft.Biome = function (
    ...
    Object.defineProperty(this, 'isDesert', {
      get: function () {
        return _biomeTypeFlags[id] ? _biomeTypeFlags[id].isDesert : id === 2;
      },
    });
    ...
    Object.defineProperty(this, 'isArctic', {
      get: function () {
        return _biomeTypeFlags[id] ? _biomeTypeFlags[id].isArctic : id === 1;
      },
    });
    ...
    Object.defineProperty(this, 'isForest', {
      get: function () {
        return _biomeTypeFlags[id] ? _biomeTypeFlags[id].isForest : id === 3;
      },
    });
  ...
  Donkeycraft.BiomeRegistry = (function () {
    ...
    function getTerrainParameters(biomeId) {
      ...
      if (
        ...
        typeof Donkeycraft.SurfaceGenerator.getBiomeParameters === 'function'
      ) {
        try {
          ...
          if (typeof console !== 'undefined' && console.warn) {
            console.warn(
              '[BiomeRegistry] Error getting terrain parameters for "' +
                biomeName +
                '":',
    ...
    function getRandomBiome() {
      if (_allBiomes.length === 0) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn(
            '[BiomeRegistry] No biomes registered, cannot return random biome'
          );
        }
        return null;
      }
